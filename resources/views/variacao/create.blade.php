...
<div class="container p-5">
    <h2 class="mb-4">Cadastrar <span class="span-texto-criar">Variação<span></h2>
    <form id="form_variacao" action="{{ route('variacoes.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            <textarea class="form-control" id="descricao" name="descricao" placeholder="Descreva a variação..." row="3"></textarea>
        </div>
        ...
        <div class="selecionar_qtd_estoque mb-3">
            <input class="form-control" type="text" id="qtd_estoque_variacao" name="qtd_estoque" placeholder="Quantidade em Estoque" pattern="\d*" inputmode="numeric">
